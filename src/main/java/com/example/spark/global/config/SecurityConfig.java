...
//import com.example.spark.global.jwt.JwtAuthenticationFilter;
//import com.example.spark.global.jwt.TokenService;
...
//    private final TokenService tokenService;
    ...
    private final String[] securityPatterns = {
            "/user/oauth/apple", "/user/refresh","/user/oauth/facebook"
    };
...
//                        .requestMatchers(AnnouncementPatterns).authenticated()
                        .requestMatchers(UserPatterns).permitAll()
                        .requestMatchers(EpisodePatterns).permitAll()
                        .requestMatchers(GemPatterns).permitAll()
                        .requestMatchers(AnnouncementPatterns).permitAll()
